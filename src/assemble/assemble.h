...
extern "C"
{
  ...
  // is_fill=1 marks an absent source chunk: the kernel writes fill_value
  // across the chunk's region and src_base_byte_off / shuffle_* are ignored.
  struct assemble_chunk
  {
    ...
    uint8_t is_fill;              // 1 = broadcast fill_value
