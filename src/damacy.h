...
extern "C"
{
  ...
  // Create a damacy instance. The current CUcontext is captured if
  // any; otherwise dev 0's primary is retained and made current. The
  // captured ctx is expected to stay current on the calling thread.
